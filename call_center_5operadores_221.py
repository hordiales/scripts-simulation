...
filename = "output-5operadores-2junior-2semisenior.csv"
...
# with open("simulaciones-5op_221.csv", 'w') as out:
#      out.write("No atendidos, T.Ocioso Op1 (junior), T.Ocioso Op2 (junior), T.Ocioso Op3 (SemiSenior), T.Ocioso Op4 (SemiSenior), T.Ocioso Op5 (senior)\n")
with open("simulaciones-5op_221.csv", 'a') as out:
